...
public interface SQLStatements {
	...
	String RESERVE_PATRON_QUERY = "SELECT PATRON_LOGINID FROM TRANSACTION WHERE TRANSACTIONMODE = 'RESERVE' AND TRANSACTIONDATE = to_date(?,'yyyy-mm-dd hh24:mi:ss')";
	...
	String LOAN_PATRON_QUERY = "SELECT PATRON_LOGINID FROM TRANSACTION WHERE TRANSACTIONMODE = 'LOAN' AND TRANSACTIONDATE = to_date(?,'yyyy-mm-dd hh24:mi:ss') AND BOOK_ISBN = ? AND BOOK_COPYNUMBER = ?";
